    ...
    return (
        <div className="bg-background flex flex-col justify-center items-center h-screen w-screen">
            <div className="flex flex-col justify-center items-center  text-center">
                <h3 className="text-primary-text text-base font-semibold mb-1">
                    404
                </h3>
                <h1 className="text-primary-text text-6xl font-bold mb-3">
                    Page not found
                </h1>
                <p className="text-primary-text text-lg w-[70%] min-w-[350px]">
