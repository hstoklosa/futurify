...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed top-[50%] left-[50%] z-50 w-[350px] max-h-[85vh] h-[50vh] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-background duration-200",
...
const DialogHeader = ({
  ...
  <div
    className={cn(
      "flex justify-center items-center h-[40px] border-b border-border",
      className
    )}
    {...props}
  />
